...
def criarPDF(voucher):
    with open('imagem_senha\\voucher.html', 'w') as senha_wifi:
        ...
        <!DOCTYPE html>
            ...
            <body>
                <img style="position:absolute;width:10.00in;height:14.00in" src="imagem_senha/ci_1.png" />
                ...
                <img style="position:absolute;top:8.00in;left:7.95in;width:0.90in;height:1.70in;transform:rotate(23deg);" src="imagem_senha/ri_1.png" />
    ...
    try:
        ...
        pdfkit.from_file(
            'imagem_senha\\voucher.html',
            'imagem_senha\\senha_wifi.pdf',
